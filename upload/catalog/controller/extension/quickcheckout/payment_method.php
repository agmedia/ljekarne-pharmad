...
class ControllerExtensionQuickCheckoutPaymentMethod extends Controller {
  	public function index() {
        ...
        \Agmedia\Helpers\Log::test($this->session->data['payment_method'], 'testing_in');
        \Agmedia\Helpers\Log::test($this->session->data['shipping_method'], 'testing_in');
	...
	public function set() {
        ...
        \Agmedia\Helpers\Log::test($this->session->data['payment_method'], 'testing_set');
        \Agmedia\Helpers\Log::test($this->session->data['shipping_method'], 'testing_set');
	}
	...
	public function validate() {
        ...
        \Agmedia\Helpers\Log::test($this->session->data['payment_method'], 'testing_val');
        \Agmedia\Helpers\Log::test($this->session->data['shipping_method'], 'testing_val');
