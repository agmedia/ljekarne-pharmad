			...
			if ($order_info) {
				...
				if (!$json) {
					...
					if ($this->cart->hasShipping()) {
                        ...
                        if (isset($this->request->post['shipping_collector_id']) && $this->request->post['shipping_method'] == 'collector.collector') {
                            if ($order_info['shipping_collector_id'] != $this->request->post['shipping_collector_id']) {
                                // Collector changed.
                                $order_data['shipping_collector_id'] = $this->request->post['shipping_collector_id'];
                            } else {
                                // Collector stays the same.
                                $order_data['shipping_collector_id'] = $order_info['shipping_collector_id'];
                            }
                        } else {
                            // No collector.
                            $order_data['shipping_collector_id'] = 0;
                        }
