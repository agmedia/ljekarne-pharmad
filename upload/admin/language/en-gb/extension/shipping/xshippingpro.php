...
$_['text_eq_all'] = 'Available when `Shipping By` is Equation Value. Placeholders denote the respective parameter value of the product. It will iterate provided ranges over products and sup up cost of all matched products.';
...
$_['help_product_or'] = 'Define how product rules would treat in case of having multiple product rules. If you are not sure, just keep default value `OR`';
...
$_['help_equation_neg'] = 'By default if the equation finds a negative value as the final result, the method become invalid. However, if you ticked this option, the method will remain always visible. ';
