...
class ControllerExtensionShippingXshippingpro extends Controller {
    ...
    public function index() {
       ...
       if (isset($this->error['warning'])) {
        ...
        $more_help['equation'] = $eq_placeholders . $this->ocm->misc->getHelpTag($data['more_equation']) . $shipping_placeholders;
    ...
    private function getFormData($data, $new_tab = false) {
        ...
        $range_types = array('quantity', 'weight', 'volume', 'dimensional', 'volumetric', 'sub', 'total', 'sub_negative', 'sub_coupon', 'total_coupon', 'grand_shipping', 'grand', 'no_package', 'no_product', 'no_category', 'no_manufacturer', 'no_location', 'distance', 'equation', 'per_manufacturer');
        $non_total_types = array('flat','quantity', 'weight', 'volume', 'dimensional', 'volumetric', 'no_package', 'no_product', 'no_category', 'no_manufacturer', 'no_location', 'distance', 'equation', 'per_manufacturer');
