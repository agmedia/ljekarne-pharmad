...
class ControllerExtensionModuleLuceedSync extends Controller
{
    ...
    public function install()
    {
        ...
        $this->db->query("ALTER TABLE " . DB_PREFIX . "_category ADD COLUMN luceed_uid VARCHAR(255) NULL AFTER parent_id;");
        $this->db->query("ALTER TABLE " . DB_PREFIX . "_manufacturer ADD COLUMN luceed_uid VARCHAR(255) NULL AFTER manufacturer_id;");
        $this->db->query("ALTER TABLE " . DB_PREFIX . "_customer ADD COLUMN luceed_uid VARCHAR(255) NULL AFTER customer_id;");
        $this->db->query("ALTER TABLE " . DB_PREFIX . "_order ADD COLUMN luceed_uid VARCHAR(255) NULL AFTER order_id;");
    }
    ...
    public function uninstall()
    {
        ...
        $this->db->query("ALTER TABLE " . DB_PREFIX . "_category DROP COLUMN luceed_uid;");
        $this->db->query("ALTER TABLE " . DB_PREFIX . "_manufacturer DROP COLUMN luceed_uid;");
        $this->db->query("ALTER TABLE " . DB_PREFIX . "_customer DROP COLUMN luceed_uid;");
        $this->db->query("ALTER TABLE " . DB_PREFIX . "_order DROP COLUMN luceed_uid;");
    }
    ...
    public function checkMinQtyOfCategories()
    {
        ...
        foreach ($categories as $category) {
            $active = false;
            $pids = ProductCategory::where('category_id', $category->id)->pluck('product_id');
