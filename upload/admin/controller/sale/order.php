...
class ControllerSaleOrder extends Controller {
	...
	public function getForm() {
		...
		if (!empty($order_info)) {
            ...
            $data['collector_list'] = \Agmedia\Kaonekad\Models\ShippingCollector::getList();

            if ($order_info['shipping_code'] == 'collector.collector') {
                $data['collector_selected']       = $order_info['shipping_collector_id'];
                $data['collector_selected_title'] = \Agmedia\Kaonekad\Models\ShippingCollector::getTitle($order_info['shipping_collector_id']);
            } else {
                $data['collector_selected']       = '';
                $data['collector_selected_title'] = '';
            }
